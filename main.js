...
function inNoAp(){
    document.getElementById("activities").innerHTML = '<h3>Selecione qual dispositivo será instalado:</h3> <br> <form><br> <input type="text"><br><input type="submit"><input type="submit" onclick="goBack()" value="Voltar"></form>';// Adicionar opções
